                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/60 overflow-hidden">
                        ...
                        <div class="p-6 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nip" value="{{ old('nip', $user->employeeDetail->nip ?? '') }}" class="input-field tracking-wide" maxlength="18" placeholder="19xxxxxxxxxxxxxxxx">
                            </div>
                            <div>
                                <label class="label">NIP Lama (9 Digit)</label>
                                <input type="text" name="nip_lama" value="{{ old('nip_lama', $user->employeeDetail->nip_lama ?? '') }}" class="input-field tracking-wide" maxlength="9" placeholder="3400xxxxx">
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/60 overflow-hidden">
                        ...
                        <div class="p-6 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="nik" value="{{ old('nik', $user->employeeDetail->nik ?? '') }}" class="input-field tracking-wide">
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/60 overflow-hidden">
                        ...
                        <div class="p-6 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_rekening" value="{{ old('nomor_rekening', $user->employeeDetail->nomor_rekening ?? '') }}" class="input-field font-bold text-slate-800 tracking-wide">
                            </div>
                        </div>
                    </div>
